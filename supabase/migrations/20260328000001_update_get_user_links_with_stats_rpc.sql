-- Ensure all columns referenced by the new RPC exist (idempotent)
ALTER TABLE public.links ADD COLUMN IF NOT EXISTS tagline_color text DEFAULT NULL;
ALTER TABLE public.links ADD COLUMN IF NOT EXISTS title_color text DEFAULT NULL;
ALTER TABLE public.links ADD COLUMN IF NOT EXISTS watermark_enabled boolean DEFAULT NULL;
ALTER TABLE public.links ADD COLUMN IF NOT EXISTS watermark_url text DEFAULT NULL;
ALTER TABLE public.links ADD COLUMN IF NOT EXISTS tagline_font_size integer DEFAULT NULL;
ALTER TABLE public.links ADD COLUMN IF NOT EXISTS banner_curve_intensity integer DEFAULT NULL;

-- Update get_user_links_with_stats to include all columns added after initial migration:
-- business_name_html, business_name_font_size, business_name_align, bg_effects,
-- hero_image_height_px, hero_object_fit, hero_focal_point, hero_image_opacity,
-- hero_overlay_opacity, hero_overlay_color, logo_size_px, logo_shape, logo_shadow,
-- logo_border_color, header_style, banner_curve, banner_curve_intensity,
-- title_color, tagline_color, tagline_font_size, watermark_enabled, watermark_url,
-- hide_business_name, hide_tagline
