            ...
            <div className="p-3 space-y-0 border-t border-border/30 divide-y divide-border/20">
              ...
              <div className="py-3 space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <Input value={button.iconEmoji || ""} onChange={(e) => onUpdate(button.id, { iconEmoji: e.target.value })} placeholder="💬 Cole ou digita um emoji" className="text-sm h-8" />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-1.5">
                    <Input value={button.badgeLabel || ""} onChange={(e) => onUpdate(button.id, { badgeLabel: e.target.value })} placeholder="NOVO · 🔥 · GRÁTIS" className="text-sm h-8 flex-1" />
                  ...
                  <p className="text-[10px] text-muted-foreground">Aparece no canto superior do botão • cor ao lado</p>
                </div>
              </div>
