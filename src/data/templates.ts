...
export const templates: LinkTemplate[] = [
  // ─────────────────────────── DELIVERY ──────────────────────────────
  {
    ...
    template: {
      ...
      fontFamily: "Inter",
      buttons: [
        { id: "1", label: "Cardápio Completo", subtitle: "Mais de 40 sabores 🍕", url: "", icon: "", gradientColor: "from-orange-500 to-orange-700", iconEmoji: "📋", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400&q=80", imagePosition: "right" as const, imageOpacity: 80, imageSize: 45, buttonStyle: "glass" as const },
        { id: "2", label: "Pedir Delivery", subtitle: "Entrega em até 45 min 🛵", url: "", icon: "", gradientColor: "from-red-600 to-red-800", iconEmoji: "🛵", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1604382355076-af4b0eb60143?w=400&q=80", imagePosition: "right" as const, imageOpacity: 75, imageSize: 40, buttonStyle: "glass" as const },
        { id: "3", label: "iFood / Rappi", subtitle: "Peça pelos apps 📱", url: "", icon: "", gradientColor: "from-red-500 to-pink-600", iconEmoji: "📲", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1571997478779-2adcbbe9ab2f?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "4", label: "Reservar Mesa", subtitle: "Jantar especial 🕯️", url: "", icon: "", gradientColor: "from-amber-600 to-amber-800", iconEmoji: "🍷", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "5", label: "Nossa Localização", subtitle: "R. das Flores, 120 📍", url: "", icon: "", gradientColor: "from-blue-600 to-blue-800", iconEmoji: "📍", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["🍕", "🧀", "🍅", "🌿"],
      blocks: [
  ...
  },
  {
    ...
    template: {
      ...
      fontFamily: "Poppins",
      buttons: [
        { id: "1", label: "Ver Cardápio", subtitle: "Smash, clássico e veggie 🍔", url: "", icon: "", gradientColor: "from-amber-500 to-amber-700", iconEmoji: "🍔", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&q=80", imagePosition: "right" as const, imageOpacity: 80, imageSize: 45, buttonStyle: "glass" as const },
        { id: "2", label: "Pedir Agora", subtitle: "Entrega em 30 min 🛵", url: "", icon: "", gradientColor: "from-red-600 to-red-800", iconEmoji: "🛵", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1550547660-d9450f859349?w=400&q=80", imagePosition: "right" as const, imageOpacity: 75, imageSize: 42, buttonStyle: "glass" as const },
        { id: "3", label: "iFood", subtitle: "Peça pelo app 📱", url: "", icon: "", gradientColor: "from-red-500 to-orange-500", iconEmoji: "📲", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "4", label: "Instagram", subtitle: "Veja nossos burgers 😍", url: "", icon: "", gradientColor: "from-purple-600 to-pink-600", iconEmoji: "📸", linkType: "instagram", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1619881590738-a111d176d906?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["🍔", "🍟", "🥤", "🔥"],
      blocks: [
  ...
  // ─────────────────────────── AÇAÍTERIA ──────────────────────────
  {
    ...
    template: {
      ...
      fontFamily: "Nunito",
      buttons: [
        { id: "1", label: "Monte Seu Açaí", subtitle: "+30 complementos 🍓", url: "", icon: "", gradientColor: "from-purple-500 to-purple-700", iconEmoji: "🫐", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1590301157890-4810ed352733?w=400&q=80", imagePosition: "right" as const, imageOpacity: 80, imageSize: 45, buttonStyle: "glass" as const },
        { id: "2", label: "Delivery", subtitle: "Receba em casa 📦", url: "", icon: "", gradientColor: "from-violet-600 to-violet-800", iconEmoji: "🛵", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1615478503562-ec2d8aa0a24a?w=400&q=80", imagePosition: "right" as const, imageOpacity: 75, imageSize: 42, buttonStyle: "glass" as const },
        { id: "3", label: "Cardápio", subtitle: "Tigelas e combos 🥣", url: "", icon: "", gradientColor: "from-fuchsia-500 to-fuchsia-700", iconEmoji: "📋", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1546548970-71785318a17b?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "4", label: "Instagram", subtitle: "Inspire-se 📸", url: "", icon: "", gradientColor: "from-pink-500 to-pink-700", iconEmoji: "📸", linkType: "instagram", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1546548970-71785318a17b?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["🫐", "🍓", "🍌", "🥣"],
      blocks: [
  ...
  // ─────────────────────────── ADVOCACIA ──────────────────────────
  {
    ...
    template: {
      ...
      fontFamily: "Raleway",
      buttons: [
        { id: "1", label: "Áreas de Atuação", subtitle: "Civil, trabalhista e mais ⚖️", url: "", icon: "", gradientColor: "from-slate-600 to-slate-800", iconEmoji: "⚖️", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=400&q=80", imagePosition: "right" as const, imageOpacity: 65, imageSize: 40, buttonStyle: "glass" as const },
        { id: "2", label: "Consulta Online", subtitle: "Agende sua consulta 📅", url: "", icon: "", gradientColor: "from-blue-600 to-blue-800", iconEmoji: "📅", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=400&q=80", imagePosition: "right" as const, imageOpacity: 65, imageSize: 40, buttonStyle: "glass" as const },
        { id: "3", label: "WhatsApp", subtitle: "Resposta em minutos ⚡", url: "", icon: "", gradientColor: "from-green-600 to-green-800", iconEmoji: "💬", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1589391886645-d51941baf7fb?w=400&q=80", imagePosition: "right" as const, imageOpacity: 65, imageSize: 38, buttonStyle: "glass" as const },
        { id: "4", label: "E-mail", subtitle: "Envie sua demanda ✉️", url: "", icon: "", gradientColor: "from-indigo-500 to-indigo-800", iconEmoji: "📧", linkType: "email", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=400&q=80", imagePosition: "right" as const, imageOpacity: 65, imageSize: 38, buttonStyle: "glass" as const },
        { id: "5", label: "LinkedIn", subtitle: "Nossa equipe 👔", url: "", icon: "", gradientColor: "from-blue-700 to-blue-900", iconEmoji: "🔗", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1568992687947-868a62a9f521?w=400&q=80", imagePosition: "right" as const, imageOpacity: 60, imageSize: 38, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["⚖️", "📜", "🏛️"],
      blocks: [
  ...
  },
  {
    ...
    template: {
      ...
      buttons: [
        { id: "1", label: "Agendar Online", subtitle: "Escolha seu horário ⏰", url: "", icon: "", gradientColor: "from-stone-600 to-stone-800", iconEmoji: "✂️", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=400&q=80", imagePosition: "right" as const, imageOpacity: 75, imageSize: 42, buttonStyle: "glass" as const },
        { id: "2", label: "Serviços & Preços", subtitle: "Corte, barba e mais 💈", url: "", icon: "", gradientColor: "from-amber-700 to-amber-900", iconEmoji: "💈", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1621605815971-fbc98d665033?w=400&q=80", imagePosition: "right" as const, imageOpacity: 72, imageSize: 40, buttonStyle: "glass" as const },
        { id: "3", label: "Instagram", subtitle: "Nossos cortes 🔥", url: "", icon: "", gradientColor: "from-purple-600 to-pink-600", iconEmoji: "📸", linkType: "instagram", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1621605815971-fbc98d665033?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "4", label: "Como Chegar", subtitle: "Rua XV de Novembro, 200 📍", url: "", icon: "", gradientColor: "from-blue-600 to-blue-800", iconEmoji: "📍", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1585747860019-f3876c62d2c0?w=400&q=80", imagePosition: "right" as const, imageOpacity: 65, imageSize: 38, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["✂️", "💈", "🧔", "🔥"],
      blocks: [
  ...
  // ─────────────────────────── FITNESS ────────────────────────────
  {
    ...
    template: {
      ...
      buttons: [
        { id: "1", label: "Ver Planos", subtitle: "A partir de R$89/mês 🎯", url: "", icon: "", gradientColor: "from-red-600 to-red-800", iconEmoji: "💪", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400&q=80", imagePosition: "right" as const, imageOpacity: 75, imageSize: 42, buttonStyle: "glass" as const },
        { id: "2", label: "Aula Experimental", subtitle: "Grátis, sem compromisso 🎉", url: "", icon: "", gradientColor: "from-orange-500 to-orange-700", iconEmoji: "📅", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "3", label: "Modalidades", subtitle: "Musculação, cardio, lutas 🥊", url: "", icon: "", gradientColor: "from-amber-600 to-amber-800", iconEmoji: "🏋️", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "4", label: "Instagram", subtitle: "Motivação diária 🔥", url: "", icon: "", gradientColor: "from-purple-600 to-pink-600", iconEmoji: "📸", linkType: "instagram", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1594737625785-a6cbdabd333c?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["💪", "🏋️", "🔥", "⚡"],
      blocks: [
  ...
  // ─────────────────────────── AUTOMOTIVO ─────────────────────────
  {
    ...
    template: {
      ...
      fontFamily: "Rubik",
      buttons: [
        { id: "1", label: "Nossos Serviços", subtitle: "Tudo para seu veículo 🛠️", url: "", icon: "", gradientColor: "from-amber-500 to-amber-700", iconEmoji: "🔧", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=400&q=80", imagePosition: "right" as const, imageOpacity: 75, imageSize: 42, buttonStyle: "glass" as const },
        { id: "2", label: "Agendar Revisão", subtitle: "Horário disponível 📅", url: "", icon: "", gradientColor: "from-blue-600 to-blue-800", iconEmoji: "📅", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1530046339160-ce3e530c7d2f?w=400&q=80", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "3", label: "Pedir Orçamento", subtitle: "Resposta rápida 💬", url: "", icon: "", gradientColor: "from-green-600 to-green-800", iconEmoji: "💬", linkType: "whatsapp", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=400&q=80", imagePosition: "right" as const, imageOpacity: 65, imageSize: 38, buttonStyle: "glass" as const },
        { id: "4", label: "Como Chegar", subtitle: "Estrada das Indústrias, 500 📍", url: "", icon: "", gradientColor: "from-zinc-600 to-zinc-800", iconEmoji: "📍", linkType: "external", linkValue: "", imageUrl: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=400&q=80", imagePosition: "right" as const, imageOpacity: 65, imageSize: 38, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["🔧", "🚗", "⚙️", "🔩"],
      blocks: [
  ...
  // ─────────────────────────── CREATOR ────────────────────────────
  {
    ...
    template: {
      ...
      buttons: [
        { id: "1", label: "YouTube", subtitle: "Inscreva-se no canal 🎬", url: "", icon: "", gradientColor: "from-red-600 to-red-800", iconEmoji: "▶️", linkType: "youtube", linkValue: "", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "2", label: "Instagram", subtitle: "Siga meu dia a dia 📸", url: "", icon: "", gradientColor: "from-purple-500 to-pink-600", iconEmoji: "📸", linkType: "instagram", linkValue: "", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "3", label: "TikTok", subtitle: "Reels e vídeos curtos 🎵", url: "", icon: "", gradientColor: "from-zinc-700 to-zinc-900", iconEmoji: "🎵", linkType: "tiktok", linkValue: "", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "4", label: "Parcerias & Publi", subtitle: "Me chama para colaborar 💼", url: "", icon: "", gradientColor: "from-violet-600 to-violet-800", iconEmoji: "💼", linkType: "email", linkValue: "", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "5", label: "Loja Oficial", subtitle: "Produtos exclusivos 🛍️", url: "", icon: "", gradientColor: "from-fuchsia-600 to-fuchsia-800", iconEmoji: "🛍️", linkType: "external", linkValue: "", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["🎬", "✨", "🔥", "💜"],
      blocks: [
  ...
  // ─────────────────────── RESTAURANTE JAPONÊS ────────────────────
  {
    ...
    template: {
      ...
      buttons: [
        { id: "1", label: "Cardápio Digital", subtitle: "Sushi, temaki e mais 🍣", url: "", icon: "", gradientColor: "from-red-800 to-stone-800", iconEmoji: "🍱", linkType: "external", linkValue: "", imagePosition: "right" as const, imageOpacity: 75, imageSize: 42, buttonStyle: "glass" as const },
        { id: "2", label: "Reservar Mesa", subtitle: "Experiência completa 🥢", url: "", icon: "", gradientColor: "from-red-700 to-red-900", iconEmoji: "🥢", linkType: "whatsapp", linkValue: "", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "3", label: "Delivery", subtitle: "Entrega em até 50 min 🛵", url: "", icon: "", gradientColor: "from-stone-700 to-stone-900", iconEmoji: "🛵", linkType: "whatsapp", linkValue: "", imagePosition: "right" as const, imageOpacity: 70, imageSize: 40, buttonStyle: "glass" as const },
        { id: "4", label: "Instagram", subtitle: "Arte em cada prato 📸", url: "", icon: "", gradientColor: "from-rose-700 to-red-900", iconEmoji: "📸", linkType: "instagram", linkValue: "", imagePosition: "right" as const, imageOpacity: 65, imageSize: 38, buttonStyle: "glass" as const },
      ],
      badges: [],
      floatingEmojis: ["🍣", "🌸", "🥢", "🍱"],
      blocks: [
  ...
  // ─────────────────────────── EDUCAÇÃO DIGITAL ───────────────────
  {
    ...
    template: {
      ...
      bgHtml: {
        enabled: true,
        html: `<style>*{margin:0;padding:0}body{width:100%;height:100%;background:#020818;overflow:hidden}canvas{position:absolute;inset:0}</style><canvas id="c"></canvas><script>(function(){var c=document.getElementById('c'),ctx=c.getContext('2d');c.width=window.innerWidth;c.height=window.innerHeight;var N=25,nodes=[];for(var i=0;i<N;i++)nodes.push({x:Math.random()*c.width,y:Math.random()*c.height,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:2+Math.random()*2});function draw(){ctx.clearRect(0,0,c.width,c.height);for(var i=0;i<N;i++){var n=nodes[i];n.x+=n.vx;n.y+=n.vy;if(n.x<0||n.x>c.width)n.vx*=-1;if(n.y<0||n.y>c.height)n.vy*=-1;for(var j=i+1;j<N;j++){var m=nodes[j],dx=m.x-n.x,dy=m.y-n.y,dist=Math.sqrt(dx*dx+dy*dy);if(dist<120){ctx.strokeStyle='rgba(59,130,246,'+(1-dist/120)*.3+')';ctx.lineWidth=.5;ctx.beginPath();ctx.moveTo(n.x,n.y);ctx.lineTo(m.x,m.y);ctx.stroke()}}ctx.fillStyle='rgba(99,179,255,.7)';ctx.beginPath();ctx.arc(n.x,n.y,n.r,0,Math.PI*2);ctx.fill()}requestAnimationFrame(draw)}draw()})()</script>`,
        overlay: 20,
      },
      buttons: [
