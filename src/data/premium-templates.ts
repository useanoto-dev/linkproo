...
export const premiumTemplates: LinkTemplate[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    template: {
      ...
      bgHtml: {
        enabled: true,
        html: `<style>*{margin:0;padding:0}@keyframes drift{0%{opacity:0;transform:translateY(0) translateX(0) scale(.6)}12%{opacity:.9}88%{opacity:.4}100%{opacity:0;transform:translateY(-160px) translateX(var(--tx)) scale(1.1)}}@media(prefers-reduced-motion:reduce){*{animation-duration:.001ms!important}}.p{position:fixed;border-radius:50%;background:radial-gradient(circle,#a5b4fc,#6366f1);pointer-events:none;animation:drift ease-in-out infinite}</style><div class="p" style="width:3px;height:3px;left:8%;top:72%;--tx:12px;animation-duration:8s;animation-delay:0s"></div><div class="p" style="width:2px;height:2px;left:18%;top:55%;--tx:-16px;animation-duration:11s;animation-delay:-3s"></div><div class="p" style="width:4px;height:4px;left:28%;top:80%;--tx:20px;animation-duration:9s;animation-delay:-1s"></div><div class="p" style="width:2px;height:2px;left:38%;top:40%;--tx:-12px;animation-duration:13s;animation-delay:-5s"></div><div class="p" style="width:3px;height:3px;left:48%;top:65%;--tx:18px;animation-duration:10s;animation-delay:-7s"></div><div class="p" style="width:2px;height:2px;left:57%;top:50%;--tx:-20px;animation-duration:12s;animation-delay:-2s"></div><div class="p" style="width:4px;height:4px;left:67%;top:75%;--tx:14px;animation-duration:8s;animation-delay:-9s"></div><div class="p" style="width:2px;height:2px;left:76%;top:35%;--tx:-10px;animation-duration:14s;animation-delay:-4s"></div><div class="p" style="width:3px;height:3px;left:85%;top:60%;--tx:16px;animation-duration:9s;animation-delay:-6s"></div><div class="p" style="width:2px;height:2px;left:93%;top:45%;--tx:-14px;animation-duration:11s;animation-delay:-8s"></div>`,
        overlay: 0,
      },
      buttons: [
